  ...
  <body>
    ...
    <!--Navigation Bar-->
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Boat Ticket Checkout Approval </h2>
              ...
              <div class="card card-border-color card-border-color-success">
                ...
                <div class="card-body">
                  <form method ="POST">
                    ...
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Booked Boat Number</label>
                      <div class="col-12 col-sm-8 col-lg-6">
                        <input class="form-control" readonly name="train_no"  value="<?php echo $row->train_no?>" id="inputText3" type="text">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-12 col-sm-3 col-form-label text-sm-right" for="inputText3">Booked Boat Name</label>
                      <div class="col-12 col-sm-8 col-lg-6">
