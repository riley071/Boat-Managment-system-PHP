              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-face"></i><span><?php echo $row->admin_uname;?>'s Profile</span></a>
                    ...
                    <?php }?>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-train"></i><span>Boats</span></a>
                  
                    <ul class="sub-menu">
                       <li><a href="emp-add-train.php">Add Boat</a>
                       <li><a href="emp-manage-train.php">Manage Boats</a>
                    </li>
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi  mdi-square-inc-cash"></i><span>Reports</span></a>
                    <ul class="sub-menu">
