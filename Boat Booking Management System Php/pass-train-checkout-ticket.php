      ...
      <div class="page-head">
          ...
          <nav aria-label="breadcrumb" role="navigation">
            <ol class="breadcrumb page-head-nav">
              ...
              <li class="breadcrumb-item"><a href="">Boat Tickets</a></li>
            ...
            <div class="col-sm-12">
               ...
               */         
                ...
                while($row=$res->fetch_object())
                 {
                    ?>
                <div class="card-header"><?php echo $row->pass_fname;?> <?php echo $row->pass_lname;?>  This Is Your Booked Boat Proceed to checkout your ticket!   
                <?php }?>             
                </div>
