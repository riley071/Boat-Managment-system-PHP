              ...
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="#"><i class="icon mdi mdi-face"></i><span><?php echo $row->pass_uname;?>'s Profile</span></a>
                    ...
                    <?php }?>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-basket"></i><span>Boats</span></a>
                  
                    <ul class="sub-menu">
                       <li><a href="pass-all-available-trains.php">All Available Boats</a>
                       <li><a href="pass-search-available-trains.php">Search Boat</a>
                    </li>
                      
                    </ul>
                
                  </li>
                  <li class="parent"><a href="#"><i class="icon mdi mdi-briefcase-edit-outline"></i><span>Book Boat</span></a>
                    <ul class="sub-menu">
                      <li><a href="pass-book-train.php">Reserve Boat</a>
                      </li>
                      <li><a href="pass-cancel-train.php">Cancel Boat</a>
                      </li>
